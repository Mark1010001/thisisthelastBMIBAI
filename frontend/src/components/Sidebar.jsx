            ...
            return (
              <button
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg border transition-all text-left ${
                  active ? 'border-border-dim bg-bg-card' : 'border-border-sidebar bg-bg-input'
                }`}
              >
        ...
        {[
          ...
          <button
            ...
            className={`flex-1 py-3 text-[10px] font-black uppercase tracking-widest transition-all relative ${
              activeTab === tab.id ? 'text-text-header' : 'text-text-dim hover:text-text-muted'
            }`}
          >
            {tab.label}
            {activeTab === tab.id && (
          ...
          <>
            ...
            {results && (
              <div className="mb-3 rounded-lg bg-bg-input border border-border-sidebar">
                <div className="px-3 pt-3 pb-2 border-b border-border-dim">
            ...
            {results && (
              <div className="mb-3 rounded-xl bg-bg-input border border-border-sidebar p-3">
                <p className="text-[11px] font-black text-text-header uppercase tracking-wide mb-2 text-center">
                  BMI {results.bmi} — Comparison
              </p>
                ...
                <div className="flex text-[9px] font-bold text-text-muted uppercase tracking-tighter mb-1 px-1">
                  ...
                  <div className="w-[23%] text-center">Overwt</div>
                  <div className="w-[18%] text-center">Obese</div>
                  <div className="w-[29%] text-right">Category</div>
                </div>
            ...
            <div className="mb-3 rounded-xl bg-bg-input border border-border-sidebar p-3">
              ...
              <div className="mb-3">
                <div className="flex text-[11px] text-text-muted font-black uppercase tracking-tighter border-b border-border-dim pb-1.5 mb-1.5 leading-tight">
                  <div className="w-[16%]">Metric</div>
                  <div className="w-[18%] text-center">WHO</div>
                  <div className="w-[18%] text-center">SEA PH</div>
                  <div className="w-[14%] text-center">Result</div>
                  <div className="w-[34%] text-right">Status</div>
                </div>
                {[{ label: 'Male' }, { label: 'Female' }].map((row, i) => {
                  const isMatch = results && metrics.gender === row.label;
                  const bmiCat = isMatch
                    ? (activeStandard === 'Global WHO Standard' ? results.global_bmi_category : results.asian_bmi_category)
                    : null;
              ...
              <div>
                <div className="flex text-[11px] text-text-muted font-black uppercase tracking-tighter border-b border-border-dim pb-1.5 mb-1.5 leading-tight">
                  <div className="w-[13%]">BAI</div>
                  <div className="w-[16%] text-center">18–39</div>
                  <div className="w-[16%] text-center">40–59</div>
                  <div className="w-[16%] text-center">60–79</div>
                  <div className="w-[13%] text-center">Result</div>
                  <div className="w-[26%] text-right">Status</div>
                </div>
                {[
